...
namespace sibr
{
    std::string ValveIndexControllerProfile::getName() const {
        return "/interaction_profiles/valve/index_controller";
    }

    // See specs: https://registry.khronos.org/OpenXR/specs/1.0/html/xrspec.html#_valve_index_controller_profile
    std::map<OpenXRInputType, std::string> ValveIndexControllerProfile::getBindings() const {
        return {
